...
export const ADD_CAST_MOVIE = "ADD_CAST_MOVIE";
export const EDIT_CAST_MOVIE = "EDIT_CAST_MOVIE";
export const DELETE_CAST_MOVIE = "DELETE_CAST_MOVIE";
export const RESET_CAST_MOVIE = "RESET_CAST_MOVIE";
